...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "token_obtain": env("TOKEN_OBTAIN_THROTTLE_RATE", default="5/min"),
    },
}
...
LEGACY_API_DB_URL = env("ARBOCENSUS_API_DB_URL", default="")
LEGACY_APP_DB_URL = env("ARBOCENSUS_DB_URL", default="")
