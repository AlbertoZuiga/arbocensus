...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--strategy",
            choices=[s.value for s in RoutingConfig.Strategy],
            default=RoutingConfig.Strategy.GLOBAL,
        )
    ...
    def _run(self, n, seed, distribution, clusters, strategy):
        ...
        with transaction.atomic():
            ...
            config = RoutingConfig.objects.create(dataset=dataset, strategy=strategy)
