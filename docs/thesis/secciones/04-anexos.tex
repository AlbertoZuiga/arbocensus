...
$T_{\max} = 10\,800$\,s, tiempo de servicio $180$\,s), el \texttt{OptimizationJob}
...
La Tabla~\ref{tab:anexo_baseline_sweep} detalla sus parámetros.
...
variante operacional y un mismo presupuesto de \textit{solver}, con:
