...
\begin{table}[H]
  \centering
  \caption{Endpoints de autenticación y administración de usuarios.}
...
\begin{table}[H]
  \centering
  \caption{Endpoints de \textit{datasets} e importación legada.}
...
\begin{table}[H]
  \centering
  \caption{Endpoints del motor de optimización.}
...
\begin{table}[H]
  \centering
  \caption{Endpoints de rutas y captura en terreno.}
...
\begin{xltabular}{\textwidth}{@{}l X@{}}
  ...
  RF-04 & \S\ref{sec:legacy} \\
  RF-05 & \S\ref{sec:api} \\
  RF-06 & \S\ref{sec:flota} \\
  RF-07 & \S\ref{sec:solver} \\
  RF-08 & \S\ref{sec:estrategias} \\
  RF-09 & \S\ref{sec:arquitectura} \\
  RF-10 & \S\ref{sec:ui} \\
  RF-11 & \S\ref{sec:flota} \\
  RF-12 & \S\ref{sec:disyunciones} \\
  RF-13 & \S\ref{sec:modelo-datos} \\
  RF-14 & \S\ref{sec:ui} \\
  RF-15 & \S\ref{sec:ui} \\
  RF-16 & \S\ref{sec:modelo-datos} \\
  RF-17 & \S\ref{sec:modelo-datos} \\
  RF-18 & \S\ref{sec:ui} \\
  RF-19 & \S\ref{sec:ui} \\
  RF-20 & \S\ref{sec:ui} \\
  RF-21 & \S\ref{sec:recenso} \\
  RF-22 & \S\ref{sec:recenso} \\
  RF-23 & \S\ref{sec:recenso} \\
  RF-24 & \S\ref{sec:ui} \\
  RF-25 & \S\ref{sec:ui} \\
  RF-26 & \S\ref{sec:ui} \\
  RF-27 & \S\ref{sec:api} \\
