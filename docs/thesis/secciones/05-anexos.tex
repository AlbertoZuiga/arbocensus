...
\subsubsection*{Entorno de medición --- detalle}
...
\phantomsection
\subsubsection*{Instrumentación del objetivo en \texttt{area-27}}
\label{anx:objetivo-area27}
...
\phantomsection
\subsubsection*{Grilla operacional de \texttt{spatial\_term}}
\label{anx:grilla-spatial}
...
\phantomsection
\subsubsection*{Serie de auto-cruces sobre calle por instancia}
\label{anx:crossings-areas}
