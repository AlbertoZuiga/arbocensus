...
en la Sección~\ref{sec:ui}, que muestran el panel de optimización
(Ilustración~\ref{fig:ui_optimization}) y el portal del censista
(Ilustración~\ref{fig:ui_surveyor}).
