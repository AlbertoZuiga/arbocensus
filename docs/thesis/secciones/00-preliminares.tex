...
asignación de trabajo que las iteraciones anteriores no abordaron.

Esta memoria desarrolla esa etapa mediante una plataforma web que cubre el ciclo operacional
completo del re-censo y un motor de ruteo que lo planifica. El problema se formula como ruteo de
vehículos de rutas abiertas con visitas opcionales penalizadas y restricción de
...
vehicular de \textit{OR-Tools}. Los tiempos de desplazamiento peatonal se calculan con OSRM sobre
