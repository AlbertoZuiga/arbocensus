...
\textbf{no} es una restricción del modelo sino un objetivo blando: se penaliza el
...
El comportamiento descrito en este capítulo se sostiene sobre una suite de pruebas
automatizadas que se ejecuta en cada integración de cambios. La
...
Sección~\ref{sec:alcance}. No existen pruebas automatizadas de extremo a extremo: los
