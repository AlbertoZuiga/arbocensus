...
\begin{itemize}
  \item \texttt{legacy\_api} (esquema \texttt{arbocensus\_api\_app\_*})
        \citep{pizarro-zumaeta2024}: aporta
        $429$ árboles con posición explícita y especie, organizados en áreas
        pertenecientes a campañas de censo.
  \item \texttt{legacy\_app} (esquema \texttt{arbocensus\_app\_*})
        \citep{binder-cortes2022}: base de la
