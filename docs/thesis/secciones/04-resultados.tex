...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXX}
    ...
    Autocruces sobre calle$^{\S}$ & 37{,}7 (33--40 según la repetición) & sin criterio en esta corrida: descriptiva \\
    \bottomrule
  \end{tabularx}
\end{table}
...
$^{\S}$ El barrido de referencia de esta sección no instrumenta autocruces sobre
calle, solo autocruces sobre la cuerda recta entre paradas consecutivas. La cifra
...
partición (\texttt{warmstart-area27-20260730.csv})--- muestra que las duraciones de las dos rutas que reporta
\texttt{total\_estimated\_time\_sec} ---$5\,766$ y $5\,597$\,s arriba, $5\,299$ y
$5\,819$\,s en la repetición instrumentada--- no son el valor que ve la dimensión
Time del \textit{solver}: la diferencia es relleno de trayecto añadido gratis, y
ambas rutas terminan exactamente en el piso $T_{\min} = 7\,200$\,s. Con esa cifra
...
\begin{itemize}[label=--]
  ...
  \begin{itemize}
    ...
    diseño calibrado, no un defecto; el experimento de sensibilidad de la
    Sección~\ref{sec:discusion-calidad} muestra que el término inferior es el que
    sostiene el balance de carga y
    evita la fragmentación en rutas cortas. La asimetría es intencional y su efecto
    está medido.
  \end{itemize}
...
\begin{itemize}[label=--]
  ...
  superior sin considerar el trabajo real de la instancia, de modo que en censos
  de baja densidad partir y rellenar hasta el piso resulta más barato que una
