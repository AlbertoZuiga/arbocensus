...
% ---- 4.1.6 ------------------------------------------------------
\subsection{Auditoría de robustez metodológica}
\label{sec:auditoria-robustez}

La serie experimental registra dieciséis ciclos de evaluación\footnote{Se cuenta como ciclo de
...
en el recuento.} cerrados durante julio de 2026. El
