...
los 429 árboles de \texttt{legacy\_api} con posición explícita más 1\,178 de \texttt{legacy\_app}
con posición reconstruida como mediana de sus muestras por código QR (Sección~\ref{sec:legacy}),
repartidos en 10,3\,km de extensión. Esos 1\,178 son los que superaban, al momento de congelar la
instancia, una validación de calidad que entonces aplicaba el importador y que no forma parte del
sistema vigente, de modo que la instancia no puede regenerarse desde el importador actual y se
emplea siempre en su forma congelada. Los árboles son reales, pero la agrupación carece de
