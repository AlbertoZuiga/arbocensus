...
de las cifras es la de \textit{OR-Tools} (9.15).\footnote{Ver \hyperref[anx:comandos]{Anexo 3}.}
...
El perfil de tiempo del \textit{pipeline} fija el término dominante del costo de
planificación.\footnote{Ver \hyperref[anx:perfil-rendimiento]{Anexo 4}.}
