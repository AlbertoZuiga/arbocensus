...
acota la variación dentro de una corrida, no la variación entre corridas
distintas.\footnote{Ver \hyperref[anx:alcance-replicas]{Anexo 4}.}
...
biblioteca \citep{ortools} que detalla la Sección~\ref{sec:protocolo-evaluacion}. El \textit{baseline}
...
instancias versionadas en el repositorio. Las tres áreas son disjuntas por
