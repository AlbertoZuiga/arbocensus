...
42, 43 y 44), y remite, en su columna de criterio, a los criterios de aceptación comprometidos en
la Sección~\ref{sec:criterios-aceptacion}.
...
\begin{xltabular}{\textwidth}{lXX}
  ...
  \endfoot
  \bottomrule
  \multicolumn{3}{@{}p{\textwidth}@{}}{\footnotesize\textsuperscript{1} Cifra de un barrido
    distinto sobre el mismo \textit{dataset} y configuración, no de esta corrida de referencia
    (reserva de instrumento detallada en el \hyperref[anx:reservas-sensibilidad]{Anexo 4}).} \\
  \multicolumn{3}{@{}p{\textwidth}@{}}{\footnotesize\textsuperscript{2} Corresponde a las dos
    repeticiones con la matriz de costos ya en caché de una corrida de julio de 2026 que sí
    instrumentó el tiempo extremo a extremo; se detalla más abajo junto con el caso de caché
    fría.} \\
  \multicolumn{3}{@{}p{\textwidth}@{}}{\footnotesize\textsuperscript{3} Cifra de una repetición
    posterior que sí recupera la geometría real de cada tramo desde \textit{OSRM}; la corrida de
    referencia de esta sección solo instrumenta auto-cruces sobre la cuerda recta entre
    paradas.} \\
  \endlastfoot
    Número de rutas $k$ &
      25 &
...
La tabla es una composición declarada: las tres celdas marcadas con nota provienen de corridas
distintas de la de referencia, sobre el mismo \textit{dataset} y configuración. El tiempo extremo a
extremo y los auto-cruces sobre calle se incorporaron al instrumento en un ciclo posterior al de la
corrida original; el número de rutas bajo $T_{\min}$ se toma del barrido de sensibilidad a
penalizaciones, con las reservas que detalla el \hyperref[anx:reservas-sensibilidad]{Anexo 4}. De
las tres, solo el tiempo de planificación participa de un criterio de aceptación (CA-05), y su
holgura frente al umbral ---$177{,}7$\,s: $122{,}3$ medidos frente a $300$--- excede cualquier diferencia atribuible
al cambio de corrida; las otras dos son descriptivas y no sostienen criterio alguno.
...
Sección~\ref{sec:protocolo-evaluacion}. La desviación estándar de 559\,s en la duración de las
...
un total de 58\,000, y ninguna semilla se aparta más de 68\,s de su valor previo---, lo que descarta
...
configuración de producción no muestra auto-cruces apreciables ---observación cualitativa sobre las
rutas generadas; la serie sistemática de \texttt{crossings\_road} por área individual no se midió y
queda pendiente---; estos emergen al procesar
...
producción no muestran auto-cruces apreciables, y cuando los auto-cruces aparecen responden a la
función objetivo, no a una limitación del tiempo de cómputo. La segunda es la cercanía del
...
se observan sobre un área real, donde la inspección de las rutas de la configuración de producción
no muestra auto-cruces ---con la reserva, declarada allí, de que esa observación es
cualitativa---. Esto convierte la segmentación previa por área, que la
Sección~\ref{sec:posibles-mejoras} documenta como trabajo futuro, en la extensión de mayor impacto
del sistema: no porque el motor esté mal calibrado, sino porque el motor se comporta como
corresponde cuando el problema se le entrega en su escala natural.
...
\begin{itemize}[label=--]
  ...
  \begin{itemize}
    \item Base empírica de la conclusión sobre la unidad operativa: la medición de la
        Sección~\ref{sec:areas-reales} comprende tres áreas de un mismo territorio ($43$, $72$ y
