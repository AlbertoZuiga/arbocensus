...
\begin{table}[H]
  ...
  \begin{tablenotes}[flushleft]\footnotesize
    \item[1] Cifra de un barrido distinto sobre el mismo \textit{dataset} y configuración, no de
      esta corrida de referencia (reserva de instrumento detallada en el
      \hyperref[anx:reservas-sensibilidad]{Anexo 4}).
    \item[2] Corresponde a las dos repeticiones con la matriz de costos ya en caché de una corrida
      de julio de 2026 que sí instrumentó el tiempo extremo a extremo; se detalla más abajo junto
      con el caso de caché fría.
    \item[3] Cifra de una repetición posterior que sí recupera la geometría real de cada tramo desde
