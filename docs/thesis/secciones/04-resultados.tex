...
del capítulo. Las tres primeras tienen anclaje en mediciones propias de esta
memoria y se ordenan por impacto decreciente sobre las métricas evaluadas; las
cuatro restantes abordan limitaciones funcionales independientes de la serie
experimental.
...
\begin{itemize}
  ...
  \item \textbf{Compuerta de régimen por saturación}: el barrido de la
  Sección~\ref{sec:discusion-calidad} muestra que el brazo
  \texttt{upper-tmax-tmin9000} reduce los auto-cruces en un $92{,}5$\,\% en el
  régimen denso ($\overline{\text{sat}} = 0{,}94$) sin incremento de
  desplazamiento, pero los empeora en las áreas individuales donde la saturación
  es menor ($\overline{\text{sat}} \approx 0{,}67$--$0{,}73$). El umbral que
  separa ambos regímenes es $\overline{\text{sat}} \gtrsim 0{,}9$, cuantificado
  sobre los datos del barrido, y el código de los ajustes necesarios ya está en
  el árbol como opción no activa.
