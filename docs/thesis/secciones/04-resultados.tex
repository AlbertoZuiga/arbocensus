...
configuraciones operacionales del Anexo 4 ---las combinaciones de tiempo de servicio y
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    Anexo 4 construye esa cota ($\text{MSF}_k$, el bosque generador mínimo de $k$
    ...
    configuraciones medidas con la misma vara, con la reserva que el Anexo 4 detalla.
