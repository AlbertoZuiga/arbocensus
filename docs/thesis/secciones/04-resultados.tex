...
$559$\,s equivalente al $5{,}6$\,\% del promedio. La flota
...
\begin{itemize}
  ...
  \item \textbf{Alcance de la integración con Arbocensus}: RF-01 se acotó a la
  importación de árboles desde archivo (CSV o JSON) y desde las bases legadas
  mediante conexión de solo lectura (Sección~\ref{sec:legacy}), en lugar de una
  integración en vivo con las bases de datos operativas de Arbocensus. El corte
  es adecuado al alcance de esta iteración, pero deja fuera la sincronización
  continua del arbolado entre plataformas.
