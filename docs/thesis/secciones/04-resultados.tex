...
descrita en las Secciones \ref{sec:legacy} y \ref{sec:estado-actual}: 1\,607 árboles de ambas
fuentes legadas (\texttt{legacy\_api} + \texttt{legacy\_app} con mediana de posición por código QR)
repartidos en 10,3\,km de extensión. Los árboles son reales, pero la agrupación carece de correlato
operativo, dado que el censo histórico se organizó por áreas, y el conjunto no corresponde a una
única comuna: reúne una porción del arbolado disponible en ambas bases legadas, elegida por
reproducibilidad y no la totalidad del universo importable (Sección~\ref{sec:legacy}). El segundo
es el régimen de área de censo individual ---diámetros de hasta 1,32\,km---, que corresponde a la
operación habitual. La instancia agregada funciona como instancia de estrés: es la de mayor tamaño
y la que fija los criterios de aceptación del Capítulo~\ref{cap:solucion}. Las áreas reales miden
el motor en su unidad operativa (Sección~\ref{sec:areas-reales}), y varias conclusiones obtenidas
en el régimen agregado no se trasladan sin más a ellas.
