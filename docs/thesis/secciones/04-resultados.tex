...
El resultado admite además una matización dentro de esta misma corrida: el IoU del peor par no
mejora, sino que empeora levemente ($0{,}51 \rightarrow 0{,}55$; en esta métrica un valor mayor es
peor). La penalización del
