...
\textit{dataset} de este tamaño. Se reportan ocho indicadores:
...
\begin{itemize}[label=--]
  ...
  \begin{itemize}
    ...
    las tres no se ha comprobado. La métrica conserva su valor comparativo entre
    configuraciones medidas con la misma vara, con la reserva que el \hyperref[anx:auditoria-robustez]{Anexo 4} detalla.
