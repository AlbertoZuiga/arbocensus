...
instancia \texttt{reference-n1607} congelada en \texttt{docs/experiments/instances/}, cuyos
identificadores son función pura del archivo y por lo tanto reproducibles en cualquier máquina.
\end{sloppypar}
