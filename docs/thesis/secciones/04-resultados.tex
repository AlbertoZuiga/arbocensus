...
\begin{itemize}[label=--]
  ...
  \begin{itemize}
    ...
    \item Persistencia de las fotografías: la imagen que acompaña a cada observación se guarda en un
        ...
        (Sección~\ref{sec:recenso}), sin almacenamiento de objetos ni respaldo, y el despliegue de
        producción no declara un volumen que la preserve. La evidencia gráfica que el sistema exige
...
\begin{itemize}[label=--]
  \item Validación en terreno: las conclusiones de este capítulo verifican que el producto hace lo
      ...
      (Sección~\ref{sec:verificacion}). El costo es una jornada de censo real con censistas y un
