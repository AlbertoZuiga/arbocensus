...
aquí se miden contra la formulación vigente (\texttt{global}) sobre la instancia de referencia de
$n = 1\,607$ árboles.
...
\begin{table}[H]
  \centering
  \caption{Comparación de estrategias sobre la instancia de referencia.}
