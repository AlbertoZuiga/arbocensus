...
sobre la suite de instancias congeladas que describe el \hyperref[anx:suite-instancias]{Anexo 4}
---doce instancias reales entre $n=43$ y $n=1\,607$, con dos controles de densidad a extensión
constante--- (\texttt{route-config-algorithm-sweep-20260718.csv}: ocho configuraciones sobre cada
una de ellas, esto es 96 celdas, registradas en 288 filas). Cada celda se registró con tres
...
independientes: difieren solo por el corte por reloj de pared descrito en la
Sección~\ref{sec:metricas-calidad}. En 78 de las 96 celdas las tres filas
