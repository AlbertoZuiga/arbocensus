...
$b$ es un margen de holgura de $5$ vehículos ---fijo y pequeño frente al $N_{\max}$
típico, que absorbe la subestimación del estimador de vecino más cercano sin ampliar
el espacio de búsqueda de forma apreciable--- y el mínimo con $n$ impide que el
techo supere el caso degenerado de un árbol por ruta.
...
\textit{greedy} con post-pass frente a $0{,}007$\,s sin él, lo que sitúa el
post-proceso en aproximadamente $0{,}08$\,s sobre los $1\,607$ árboles de la
evaluación, cuatro órdenes de magnitud bajo el presupuesto del \textit{solver}.
