...
milisegundos, cuatro órdenes de magnitud bajo el presupuesto del \textit{solver}
(Capítulo~\ref{cap:resultados}).
...
Anexo~\ref{anx:capturas} (Ilustración~\ref{fig:ui_progress}).
