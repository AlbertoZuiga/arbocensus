...
inicia sesión y obtiene un \textit{token} JWT. En segundo lugar, constituye un
...
indefinidamente. El abandono es del cliente: el registro del trabajo permanece en
estado \texttt{running} si el \textit{worker} muere después de iniciar la tarea,
pues el sistema no implementa reconciliación por latido ni por marca de inicio. Es
una limitación asumida (Sección~\ref{sec:limitaciones}). Finalmente, se presentan las rutas resultantes: cuando el trabajo
