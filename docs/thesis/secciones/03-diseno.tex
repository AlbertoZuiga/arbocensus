...
\textit{mobile}: mapa de la ruta con las paradas numeradas según \texttt{RouteStop.sequence},
parada activa con su distancia ---dentro del radio de proximidad («en rango»), con el registro
habilitado--- y lista de paradas con su estado, con las posteriores a la activa bloqueadas hasta
