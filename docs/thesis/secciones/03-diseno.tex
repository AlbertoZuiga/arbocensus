...
Los marcadores numerados sobre el mapa reflejan el orden de visita derivado de \texttt{RouteStop.sequence}; las paradas posteriores a la activa aparecen bloqueadas hasta que el censador complete la anterior, lo que impone el orden secuencial estricto de la ruta. El botón «Registrar de todos modos» habilita el registro cuando la señal GPS no alcanza el radio de proximidad de $30$\,m.
