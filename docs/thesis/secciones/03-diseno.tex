...
\begin{itemize}
  \item \textbf{Autenticación} (\texttt{/api/auth/}): obtención y renovación de tokens \textit{JSON Web Token} (JWT) mediante \textit{djangorestframework-simplejwt}, consulta del usuario en sesión y administración de las cuentas de censadores.
...
de ese grupo ---obtención y renovación del token y consulta de la sesión propia---
