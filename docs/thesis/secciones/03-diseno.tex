...
La Ilustración~\ref{fig:ui_optimization} corresponde a la pestaña de optimización del \textit{dataset}.

\capturaui{ui-optimization.png}{Detalle de un \textit{dataset}: pestaña de optimización}{Detalle de un \textit{dataset} (\texttt{/admin/datasets/\{id\}}), pestaña de optimización: mapa con las rutas de la última optimización, la lista de candidatas a plan y el formulario de parámetros temporales.}{fig:ui_optimization}
...
La pestaña de asignación aparece en la Ilustración~\ref{fig:ui_routes}.

\capturaui{ui-routes.png}{Detalle de un \textit{dataset}: pestaña de asignación}{El mismo detalle en su pestaña de asignación: candidatas a plan con sus métricas, polilíneas coloreadas sobre la red peatonal y asignación de cada ruta a un censador.}{fig:ui_routes}
