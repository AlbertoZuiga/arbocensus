...
longitudinal (Ilustración~\ref{fig:regimen-disperso-vs-real}). Esa extensión no tiene
correlato operativo: en los datos legados, la extensión máxima de un área individual
...
\begin{figure}[H]
  ...
  \caption{Ruta con auto-cruces en el \textit{dataset} de evaluación
    ...
    El cruzamiento refleja la extensión artificial del conjunto agregado, no una
    limitación de la formulación.}
...
agregado de $n=1\,607$--- es artificial y no corresponde a la unidad operativa del sistema.
...
\begin{itemize}
  ...
  que abarca $10{,}3$\,km de extensión longitudinal--- las rutas resultantes
  reflejan esa extensión artificial, con los efectos de cruce discutidos en la
