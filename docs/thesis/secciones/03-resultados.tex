...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXX}
    ...
    Desviación estándar & 559\,s (5.5\,\% del promedio) & $< 15\,\%$ del promedio \\
...
59\,690\,s, 56\,707\,s y 58\,696\,s (media 58\,364\,s), con una dispersión
del 5.1\,\% entre el mejor y el peor resultado. Los tres valores de $k$ y de balance
coinciden, pero la varianza en el tiempo total de desplazamiento es significativa.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXX}
    ...
    Tiempo total de desplazamiento & 58\,364\,s$^*$ ($\approx$ 16\,h 13\,min) & 62\,585\,s ($\approx$ 17\,h 23\,min) \\
    Desviación estándar de $T_r$ & 559\,s & 213\,s \\
    Rutas que exceden $T_{\max}$ & 0 & 0 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
El ahorro contra \textit{greedy} es
4\,221\,s ($-6.7$\,\%), aproximadamente 70 minutos de caminata.}
...
$T_{\max}$, mientras que la de \textit{OR-Tools} es de 10\,048\,s (93.0\,\% de
