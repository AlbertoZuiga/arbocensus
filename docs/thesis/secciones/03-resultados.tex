...
penalización inferior (coeficiente $= 0$) el balance de carga cae de $0{,}838$ a
$0{,}011$ y la flota sube de 25 a 32 rutas, lo que confirma que ese componente es el
mecanismo que sostiene la distribución de carga entre rutas. La penalización superior
...
% PENDIENTE: veredicto del barrido de configuración×algoritmo (adopción con guard
% vs config única vs trabajo futuro)
