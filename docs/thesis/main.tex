...
% \romannumeral primitivo y no \roman{}: babel-spanish tipografía los romanos
% en versalitas y la plantilla exige minúsculas (i, ii, iii).
...
\usepackage{xcolor}
\usepackage{enumitem}
% align=left + labelindent=0pt: sin ellos la etiqueta va alineada a la derecha
% de su caja y queda un sangrado residual antes de la letra.
\setlist[enumerate,1]{leftmargin=*, align=left, labelindent=0pt}
