...
`spatial_term` · `global` · `greedy`. (`spatial_term`+`actual` es la celda compartida con el eje CONFIG.)
...
Antes del barrido completo se corrió una celda de humo (las 8 celdas sobre `area-29-n43`,
...
Cifras promediadas sobre 3 semillas. Fuente: CSV versionado. `Δviaje` / `Δcruces` son relativos
a `actual` de la misma instancia.

### `reference-n1607` — el objetivo real (censo completo, denso)

| celda | k | viaje | balance | cruces | IoU | walk | sat | relleno | Δviaje | Δcruces |
| --- | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: |
...
| instancia (n) | celda | viaje | balance | cruces | Δviaje | Δcruces_abs |
| --- | --- | --: | --: | --: | --: | --: |
...
### Tiempos por fase (n=1607, promedio 3 semillas)

| celda | osrm | model_build | first_solution | metaheurística | wall-clock |
| --- | --: | --: | --: | --: | --: |
