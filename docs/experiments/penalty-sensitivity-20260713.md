...
- Branch: `feat/penalty-sensitivity` (PR #162), sobre main `c51efad` (que ya incluye Q0, PR #154)
...
**Hallazgo lateral, fuera del criterio (relevante para F12/Q1b):** mover el soft upper a T_max —o
