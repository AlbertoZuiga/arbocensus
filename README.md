...
El sistema recibe un conjunto de árboles georreferenciados y un polígono delimitador del área de trabajo, generando rutas caminables óptimas para *N* censantes. Considera caminabilidad real, tiempos de censo, carga por agente y heurísticas avanzadas de optimización.

**Características principales:**
- Caminabilidad real usando Google Maps (modo *walking*).  
...
*(Todo el bloque matemático original se mantiene tal cual.)*
